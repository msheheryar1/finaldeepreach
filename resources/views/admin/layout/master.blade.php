...
<meta name="_token" content="{{csrf_token()}}" />
  <title>@yield('title','Admin Dashboard - DeepReach')</title>
  <!-- Favicon -->
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link @yield('dashboard_active')" href="{{route('admin_dashboard')}}">
              <i class="ni ni-tv-2 text-blue"></i> Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link @yield('user_active')" href="{{route('admin_user')}}">
              <i class="fas fa-users text-blue"></i> Users
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link @yield('user_active')" href="{{route('admin_user_add')}}">
              <i class="fas fa-user-plus text-blue"></i>Add User
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link @yield('user_add_active')" href="{{route('admin_domain')}}">
              <i class="fas fa-globe-americas text-blue"></i> Domains
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link @yield('coupon_active')" href="{{route('admin_coupon')}}">
              <i class="fas fa-globe-americas text-blue"></i> Coupons
            </a>
          </li>
        
          <li class="nav-item">
            <a class="nav-link @yield('profile_active')" href="{{route('admin_profile')}}">
