...
@section('title','Card Completed - Deep Reach')
@section('content')
...
<div class="upload_long row" >
	<div id="input_url">
	    ...
	    $url2 = $card->site.'/dr.php?card='.$card->slug;
	     ...
	     ?>
	    @if($card!=[])
		<input type="url" id="copy_this_link" name="" value="{{$url}}">
		@else
		<h4>abc</h4>
		@endif
	</div>
...
<div class="row  my-0 mt-3" style="margin:0;">
	<div class="col-lg-12 col-12 text-center text-white">
		...
		<i  class="fa fa-facebook social_share" onClick='window.open("https://www.facebook.com/sharer/sharer.php?u={{$url}}", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=200,height=200");'  style="background-color:#3b5998"></i>
		<i class="fab fa-twitter social_share" onClick='window.open("http://twitter.com/share?url={{$url2}}", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=600,height=600");' style="background-color:#38A1F3;"></i>
		...
		<i class="fab fa-linkedin-in social_share"  onClick='window.open("http://www.linkedin.com/shareArticle?mini=true&url={{$lin_url}}&title=&summary=&source=", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=600,height=600");' style="background-color:#0077B5;"></i>
	
		<i class="fab fa-pinterest social_share" onClick='window.open("http://pinterest.com/pin/create/button/?url={{$url}}", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=600,height=600");' style="background-color:#c8232c;"></i>
		
			<!--<i class="fab fa-slack-hash social_share" onClick='window.open("http://pinterest.com/pin/create/button/?url={{$url}}", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=600,height=600");' style="background-color:#000000;"></i>-->
	</div>
...
<div class="row text-center my-0" style="margin:0;">
	...
	<div class="new_btn">
		<br>
	<div id="new_btn1">
		<button type="button" onClick="location.href='{{route('home')}}'" name="">Create New Card &nbsp;<i class="fas fa-magic"></i></button>
	</div>
	<div id="new_btn2">
		<button type="button" onClick="location.href='{{route('make-card')}}'" name="">Create Similar Card &nbsp;<i class="far fa-copy"></i></button>
	</div>
</div>
         ...
         <div class="slider_main">
            <div class="your-class">
               <div class="social_cards">
                  <div id="static_slide" style="height: 276px;">
			        <img src="{{asset('media/upload_image')}}/{{$card->fb_image}}" width="100%" height="100%"> 

		            </div>
                  <div id="card_det" class="fb_card">
                     <a href=""><span class="fb_destination" style="display:none;"></span>{{$_SERVER['HTTP_HOST']}}</a>
                     <h6><span class="fb_title">{{$card->title}}</span><span class="continue_dots" style="display: none;">...</span></h6>
                     <p><span class="fb_description">{{$card->description}}</span><span class="continue_dots" style="display: none;">...</span></p>
                  </div>
               ...
               <div class="social_cards">
                  ...
                  <div id="card_det" style="" class="fb_card">
                     ...
                     <p style="
                        ...
                        text-overflow: ellipsis;"><span class="fb_description">{{$card->description}}</span><span class="continue_dots" style="display: none;">...</span></p>
                     <a style="" href=""><span class="fb_destination" style="display:none;"></span>{{$_SERVER['HTTP_HOST']}}</a>
                  </div>
               </div>
            </div>
            <div class="your-class">
            ...
            <div class="your-class">
               <div class="social_cards pt-5">
                  ...
                  <div id="card_det" style="margin:0 auto;" class="fb_card">
                     <h6><span class="fb_title">{{$card->title}}</span><span class="continue_dots" style="display: none;">...</span><span style="float: right;font-weight: bold;font-size: 14px;margin-top: -5px;"> ...</span></h6>
                  </div>
            ...
            <div class="your-class">
               <div class="social_cards mt-5">
                  <div id="card_det" style="margin:0 auto;" class="fb_card">
                     <h6><span class="fb_title" style="color:#1264a3;font-family: 'Lato', sans-serif;font-weight: 500;">{{$card->title}}</span><span class="continue_dots" style="display: none;">...</span></h6>
                     <p style="
                        word-wrap: break-word;
                        overflow: hidden;
                        -webkit-line-clamp: 2;
            ...
            <div class="your-class mt-5">
               <div class="social_cards row bg-white">
                  ...
                  <div id="card_det2" class="fb_card" style="float:left;height:100%;">
                     ...
                     <h6><span class="fb_title">{{$card->title}}</span><span class="continue_dots" style="display: none;">...</span></h6>
                     <p><span class="fb_description">{{$card->description}}</span><span class="continue_dots" style="display: none;">...</span></p>
                     <a style="margin-top: 55px;float: left;" href=""><span class="fb_destination" style="display:none;"></span>{{$_SERVER['HTTP_HOST']}}</a>
                  </div>
             ...
             <div class="your-class mt-5">
               <div class="social_cards row bg-white" style="">
                  ...
                  <div id="card_det2" style="height: 100%;border-top-right-radius: 6px;border-bottom-right-radius: 6px;" class="fb_card">
                     ...
                     <h6><span class="fb_title">{{$card->title}}</span><span class="continue_dots" style="display: none;">...</span></h6>
                     <p class="my-0"><span class="fb_description">{{$card->description}}</span><span class="continue_dots" style="display: none;">...</span></p>
                     <a style="text-transform: lowercase;" href=""><span class="fb_destination" style="display:none;"></span>{{$_SERVER['HTTP_HOST']}}</a>
                  </div>
               </div>
            </div>
