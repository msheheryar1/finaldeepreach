...
<link href="{{asset('css/dropzone2.css')}}" rel="stylesheet">
<style>
   .box
   {
...
<div class="upload_long row">
	<form action="{{route('image_upload_url')}}" class="image_url_form" method="post" style="width: 100%">
		@csrf
	<div id="input_url">
...
<div id="drop_here_main" class="row">
	<div id="drop_here">
	    <form action="{{route('image_upload_drop')}}" method="post" enctype="multipart/form-data" class="dropzone dz-clickable" id="dropzonewidget">
                  @csrf
                 
               <div class="dz-default dz-message"><span><img src="{{asset('media/drop.png')}}" width="80px">
		&nbsp;
...
<form style="display:none;" id="image_upload_form" enctype="multipart/form-data" action="{{route('image_upload')}}" method="post">
...
<div id="main_body" style="padding-top:20px;" class="row">
    ...
    <div class="main_div2 col-lg-6 mt-4 col-md-12 col-sm-12 col-12">
      <div id="static_slide2" class="row">
         ...
         <p><img src="{{asset('media/cards.png')}}" width="350px"></p>
      </div>
   </div>
   <div class="main_div1 mt-4 col-lg-6 col-md-12 col-sm-12 col-12">
      ...
      <p><img src="{{asset('media/icon-1.png')}}" width="40px"> &nbsp; <b>Upload Your Image</b></p>
      <p><img src="{{asset('media/icon-2.png')}}" width="40px"> &nbsp; <b>Write Title & Description</b></p>
      <p><img src="{{asset('media/icon-3.png')}}" width="40px"> &nbsp; <b>Share it on Social Media!</b></p>
   </div>
