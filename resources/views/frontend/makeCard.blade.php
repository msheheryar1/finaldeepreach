...
@section('title','Make Card - Deep Reach')
@section('content')
...
<div id="main_section">
   <div id="in_main_section">
      ...
      @endforeach
      @endif
      <form action="{{route('finish_card')}}" id="form" method="POST" enctype="multipart/form-data">
         @csrf
         <input type="hidden" id="imagebase64" name="imagebase64">
         <input type="hidden" name="site">
         <div class="upload_long">
            <div id="make_card1_btn">
                <button type="button" onClick="location.href='{{route('home')}}'" ><i class="fas fa-angle-left"></i> &nbsp;&nbsp;&nbsp;&nbsp;Back </button>
               
            </div>
            <div class="make_card1">
               <div id="make_card1">
                  <input type="text" required class="title" value="{{session('c_title')}}" name="title" placeholder="Enter Your Title">
               </div>
               <div id="make_card1">
                  <input type="text" required class="description" value="{{session('c_description')}}" name="description" placeholder="Enter Your Description">
               </div>
            </div>
         </div>
         ...
         <div class="upload_long row">
            <div class="make_card1">
               <div id="make_card1">
                  <input type="text" required name="destination" value="{{session('c_destination')}}" class="destination" placeholder="Enter Destination URL">
               </div>
               <div id="make_card1">
            ...
            <div class="make_card1">
               ...
               <div id="make_card1" class="domain_dropdown" style="display:none;">
                  <select class="card_size_select" name="custom_domain">
                     ...
                     @forelse($domains as $mydomain)
                        <option value="{{$mydomain->domain}}">{{$mydomain->domain}}</option>
      ...
      <div class="upload_long row" >
         <div id="input_url">
            <input type="url" name="" placeholder="Enter Image Url">
         </div>
      ...
      <div id="drop_here_main" class="row">
         <div id="drop_here">
            <img src="{{asset('media/drop.png')}}" width="80px">
            &nbsp;
            <h4>Drop Image Here</h4>
         </div>
         <div id="or">or</div>
         <div id="upload_here">
            <input type="button" name="" value="Upload">
         </div>
      </div>
      --}}
   </div>
...
<script type="text/javascript">
   $(function() {
     ...
     basic.croppie('bind', {
       url: '{{asset('media/upload_image')}}/{{session('image_name')}}',
...
<script>
 var pixie = new Pixie({
    ...
    document.querySelector('#button').addEventListener('click', function() {
        pixie.openEditorWithImage("{{asset('media/upload_image')}}/{{session('image_name')}}");
    });
