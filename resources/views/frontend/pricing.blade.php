...
@section('title','Pricing - Deep Reach')
@section('content')

	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css">
	<link rel="stylesheet" href="{{asset('asset/pricing/assets/css/style.css')}}">
				...
				<div class="gg-pricing-table icon-table col-md-12 mt-50">
						...
						<div class="single-pricing-table text-center clearfix">
							...
							<div class="pricing-table-heading">
								<div class="pricing-icon">
									<img src="{{asset('asset/pricing/assets/images/bicycle.png')}}" alt="" class="center-block img-responsive">
								</div>
								<h2>Basic Plan</h2>
							</div>
							<!-- Price -->
							...
							<div class="pricing-button">
								<a href="{{route('signup')}}" class="btn btn-pricing"><i class="fa fa-check"></i> Sign Up</a>
							</div>
							@endif
						</div>
					</div>
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 pull-left">
						<div class="single-pricing-table text-center clearfix">
							...
							<div class="pricing-table-heading">
								<div class="pricing-icon">
									<img src="{{asset('asset/pricing/assets/images/vespa-1.png')}}" alt="" class="center-block img-responsive">
								</div>
								<h2>Pro Plan</h2>
							</div>
							<!-- Price -->
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 pull-left">
						<div class="single-pricing-table text-center clearfix">
							...
							<div class="pricing-table-heading">
								<div class="pricing-icon">
									<img src="{{asset('asset/pricing/assets/images/car.png')}}" alt="" class="center-block img-responsive">
								</div>
								<h2>Elite Plan</h2>
							</div>
							<!-- Price -->
							...
							@if(Auth::user())
        						...
        						<div class="pricing-button">
        								<a href="{{route('package-details')}}" data-plan='Elite' data-id="" data-price='13.99' class="btn btn-pricing"><i class="fa fa-check"></i>Upgrade</a>
        							</div>
...
<div class="order-summary" ><div class="order-summary-title" style="border: 1px solid rgb(40, 56, 76); border-radius: 5px 5px 0px 0px; padding: 15px 10px; color: white; font-size: 16px !important; background: rgb(40, 56, 76);">
        ...
        <div class="order-summary-body" style="border-width: 0px 1px 1px; border-top-style: initial; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-top-color: initial; border-right-color: rgb(181, 181, 181); border-bottom-color: rgb(181, 181, 181); border-left-color: rgb(181, 181, 181); border-image: initial; border-radius: 0px 0px 5px 5px; padding: 10px; background: rgb(250, 250, 250); font-size: 16px !important; color: rgb(0, 0, 0);"> 
        	<div class="row">
        		<div class="col col-8 selected_plan">Pro Plan
        		</div>
        		<div class="col col-4 text-right">$8.99
        		</div>
        	</div> 
        	<div style="border-bottom: 1px dashed rgb(181, 181, 181); margin: 10px 0px;">
        		
        	</div> <!----> <!----> <!----> <!----> <!----> <!----> 
        	<div class="row">
        		<div class="col col-8 d-flex" style="font-weight: 600;">
        			<div class="text-right">
                        Coupon Code <input type="form-control" id="coupon_code" name=""><button class="coupon_click ml-2 btn btn-sm mybtn-primary">Apply</button> <!----></div>
                    </div> 
                    <div class="col col-4 text-right coupon_price" style="font-weight: 600;">-$0.00</div>
                </div> <!---->
            </div> 
        	<div style="border-bottom: 1px dashed rgb(181, 181, 181); margin: 10px 0px;">
...
<script src="https://js.stripe.com/v3/"></script>
	...
	<script src="{{asset('asset/pricing/assets/js/bootstrap.min.js')}}"></script>
...
function final_total(){
		...
		var coupon_dis = parseFloat(plan_price)*parseFloat(coupon_perc)/100;
		var total = parseFloat(plan_price) - parseFloat(coupon_dis);
		$(".total_price").html('$'+total);
		if(coupon_perc!=0){
			$(".coupon_price").html('-$'+total);	
		}
                  ...
                  success: function(data){
                      if(data!=''){
                                    GrowlNotification.notify({
                                      ...
                                      image: "{{asset('dist/img/success.png')}}",
                                      type: 'success',
                                      position: 'top-right',
                                      closeTimeout: 3000
                                    });
                                    $(".coupon_click").remove();
                                    coupon_perc = parseFloat(data);
                                    alert(coupon_perc);
                                    final_total();
...
<!--<form action="{{route('subscription-created')}}" method="post">-->
