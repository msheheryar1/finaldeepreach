				...
				<div class="gg-pricing-table icon-table col-md-12 mt-50">
						...
						<div class="single-pricing-table text-center clearfix">
							...
							<div class="pricing-item">
								<ul>
									...
									<li><p><del><strong>Dashboard</strong> Access</del></p></li>
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 pull-left">
						<div class="single-pricing-table text-center clearfix">
							...
							<?php if(Auth::user()): ?>
							<div class="pricing-button">
								<a href="#" data-plan='Pro' data-price='8.99' class="upgrade_btn btn btn-pricing"><i class="fa fa-check"></i>Upgrade</a>
							</div>
					...
					<div class="col-12 col-sm-12 col-md-6 col-lg-4 pull-left">
						<div class="single-pricing-table text-center clearfix">
							...
							<?php if(Auth::user()): ?>
							<div class="pricing-button">
								<a href="#" data-plan='Elite' data-price='13.99' class="upgrade_btn btn btn-pricing"><i class="fa fa-check"></i>Upgrade</a>
							</div>
...
<script src="https://js.stripe.com/v3/"></script>
        	...
        	<div class="braintree-option braintree-option__card py-3 pl-3" style="border-collapse: collapse;border:2px solid #B5B5B5;background-color: #FAFAFA;" tabindex="0">
<div class="braintree-option__label" aria-label="Paying with Card">
 <i class="fab fa-paypal" style="color:#3b7bbf;font-size: 24px;"></i> &nbsp;&nbsp;Paypal
  <div class="braintree-option__disabled-message"></div>
</div>
</div>
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sheheryar\resources\views/frontend/pricing.blade.php ENDPATH**/ ?>