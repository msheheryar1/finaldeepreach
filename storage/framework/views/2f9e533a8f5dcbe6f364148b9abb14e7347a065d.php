      ...
      <form action="<?php echo e(route('finish_card')); ?>" id="form" method="POST" enctype="multipart/form-data">
         ...
         <div class="upload_long">
            ...
            <div class="make_card1">
               <div id="make_card1">
                  <input type="text" required class="title" value="<?php echo e(session('c_title')); ?>" name="title" placeholder="Enter Your Title">
               </div>
               <div id="make_card1">
                  <input type="text" required class="description" value="<?php echo e(session('c_description')); ?>" name="description" placeholder="Enter Your Description">
               </div>
            </div>
         </div>
         ...
         <div class="upload_long row">
            <div class="make_card1">
               <div id="make_card1">
                  <input type="text" required name="destination" value="<?php echo e(session('c_destination')); ?>" class="destination" placeholder="Enter Destination URL">
               </div>
               <div id="make_card1">
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_august\getdata-master\deepreach2\resources\views/frontend/makeCard.blade.php ENDPATH**/ ?>