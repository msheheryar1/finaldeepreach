<?php $__env->startSection('title','Add Domain - DeepReach'); ?>
...
<div class="container-fluid mt-3 py-4">
	...
	</div> <a download href="<?php echo e(asset('drwp.zip')); ?>" class="btn mybtn-primary">Download WordPress Plugin</a>
	...
	</div> <a download href="<?php echo e(asset('dr.php')); ?>" class="btn mybtn-primary">Download PHP Script</a>
...
<div>
   ...
   <p><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;">4.) Add a new record for the root domain name:</span><br><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;">– Record type: <strong>CNAME</strong></span><br><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;">– Hostname (or Name): @</span><br><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;">– Point to (or Address/Value): <strong><?php echo e($_SERVER['HTTP_HOST']); ?></strong></span></p>
   <p><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;">Add another record to support also “www.mydomainname.com” redirection:</span><br><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;">– Record type: <strong>CNAME</strong></span><br><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;">– Hostname (or Name): <strong>www</strong></span><br><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;">– Point to (or Address/Value): <strong><?php echo e($_SERVER['HTTP_HOST']); ?></strong></span></p>
   <p><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;"><strong>Finally, add the last record to support any random appendages to your domain:</strong></span><br><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;"><strong>– Record type: CNAME</strong></span><br><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;"><strong>– Hostname (or Name): *</strong></span><br><span style="color: rgb(51,51,51);font-size: 15px;font-family: Roboto, sans-serif;"><strong>– Point to (or Address/Value): <?php echo e($_SERVER['HTTP_HOST']); ?></strong></span><br></p>
  ...
  <script>
      ...
      $(".submit_website").click(function(){
          ...
          $.ajaxSetup({
               ...
               $.ajax({
                  url: "<?php echo e(route('check_domain')); ?>",
                  method: 'post',
                  data: {
                     url: $(".domain_url").val(),
                  },
          ...
          $.ajaxSetup({
               ...
               $.ajax({
                  url: "<?php echo e(route('check_domain2')); ?>",
                  method: 'post',
                  data: {
                     url: $(".domain_url2").val(),
                  },
...
<?php echo $__env->make('panel.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/deepreach/resources/views/panel/add_domain.blade.php ENDPATH**/ ?>