...
<meta name="_token" content="<?php echo e(csrf_token()); ?>" />
  <title><?php echo $__env->yieldContent('title','Admin Dashboard - DeepReach'); ?></title>
  <!-- Favicon -->
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <ul class="nav align-items-center d-md-none">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
            ...
            <a href="<?php echo e(route('admin_profile')); ?>" class="dropdown-item">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link <?php echo $__env->yieldContent('dashboard_active'); ?>" href="<?php echo e(route('admin_dashboard')); ?>">
              <i class="ni ni-tv-2 text-blue"></i> Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo $__env->yieldContent('user_active'); ?>" href="<?php echo e(route('admin_user')); ?>">
              <i class="fas fa-users text-blue"></i> Users
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo $__env->yieldContent('user_active'); ?>" href="<?php echo e(route('admin_user_add')); ?>">
              <i class="fas fa-user-plus text-blue"></i>Add User
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo $__env->yieldContent('user_add_active'); ?>" href="<?php echo e(route('admin_domain')); ?>">
              <i class="fas fa-globe-americas text-blue"></i> Domains
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link <?php echo $__env->yieldContent('coupon_active'); ?>" href="<?php echo e(route('admin_coupon')); ?>">
              <i class="fas fa-globe-americas text-blue"></i> Coupons
            </a>
          </li>
        
          <li class="nav-item">
            <a class="nav-link <?php echo $__env->yieldContent('profile_active'); ?>" href="<?php echo e(route('admin_profile')); ?>">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0"><?php echo e($users->count()); ?></span>
                    </div>
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    <span class="text-danger mr-2"><i class="fas fa-level-up-alt"></i>Registered On Site</span>
                  </p>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    <span class="text-danger mr-2"><i class="fas fa-level-up-alt"></i>Of All Users Combined</span>
                  </p>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    <span class="text-warning mr-2"><i class="fas fa-arrow-up"></i>Of All Users Combined</span>
...
</html><?php /**PATH E:\laravel_august\getdata-master\deepreach2\resources\views/admin/layout/master.blade.php ENDPATH**/ ?>