        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link <?php echo $__env->yieldContent('user_active'); ?>" href="<?php echo e(route('admin_user')); ?>">
              <i class="fas fa-globe-americas text-blue"></i> Users
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo $__env->yieldContent('domain_active'); ?>" href="<?php echo e(route('admin_domain')); ?>">
...
</html><?php /**PATH /var/www/html/deepreach/resources/views/admin/layout/master.blade.php ENDPATH**/ ?>