...
<form class="login_form" action="<?php echo e(route('do_login')); ?>" method="post">
					...
					<div class="flex-sb-m w-full p-t-3 p-b-32">
						...
						<div>
							<a href="#" class="txt1" data-toggle="modal" data-target="#exampleModal">
								Forgot Password?
							</a>
						</div>
					</div>
...
</html><?php /**PATH E:\laravel_september\finaldeepreach\resources\views/frontend/signup.blade.php ENDPATH**/ ?>