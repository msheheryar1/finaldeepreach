...
$(".coupon_click").click(function(){
               ...
               $.ajax({
                  url: "<?php echo e(route('validate_coupon')); ?>",
                  method: 'post',
                  data: {
                  ...
                  success: function(data){
                      if(data!=''){
                                    GrowlNotification.notify({
                                      ...
                                      image: "<?php echo e(asset('dist/img/success.png')); ?>",
                                      type: 'success',
                                      position: 'top-right',
                                      closeTimeout: 3000
                                    });
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel_august\getdata-master\deepreach2\resources\views/frontend/pricing.blade.php ENDPATH**/ ?>